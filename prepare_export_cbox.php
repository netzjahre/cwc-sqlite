...
if ($_GET[action]=="dump" && $_GET[id]<$number_of_sites) {
	...
	echo "<form action = 'expimp_csv_check_lite.php' method = 'POST'>";////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	echo "<div><a href='sort_by_uri_lite.php'>Sort list by URL</a></div>";
	echo "</div>";
	echo "<p align='center'><a href='count_all_uri_lite.php'>Look at archive before export</a></p>";
	echo "<p align='center'><input id='expimp' type='submit' name='expimp' value='Export checked rows to archive'/></p>";
	echo "</form>";
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	echo " and <input type='submit' name='botrubber' value='Delete most bots'></p>";
	echo "</form>";
