...
//delete entries
		...
		if(isset ($_POST[remotehost]))
			{
			//$remotehost = htmlentities(stripslashes($_POST[Remote-Host]));
			...
			$remotehost = "%$remotehost%";
				try
				{
					...
					$stmt = $db->query("DELETE FROM $tablename[$sid] WHERE remote_host LIKE '$remotehost'");
