...
echo "<p align='center'>or insert left-aligned a part of   <input type='text' name='useragent' value='User Agent' maxlength='15' size='15'>";
...
echo "<div>";
echo "<form action = 'delete_useragent_lite.php' method = 'POST'>";
echo "<p align='center'>or insert a part of   <input type='text' name='useragent' value='User Agent' maxlength='50' size='20'> and <input type='submit' name='agentrubber' value='delete rows'></p>";
//echo " and <input type='submit' name='agentrubber' value='delete rows'></p>";
echo "</form>";
